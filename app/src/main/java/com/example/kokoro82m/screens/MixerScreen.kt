...
fun MixerScreen(
    ...
    Column(
        ...
        Text("语速: $speed", style = MaterialTheme.typography.labelLarge)
        Slider(
            value = speed,
        ...
        Row(
            ...
            Button(
                ...
                Text(if (isProcessing) "混合中..." else "应用混合")
            }
        }
    }
}
...
private suspend fun mixStyles(
    ...
    require(styles.isNotEmpty()) { "至少选择一种音色" }
    require(styles.all { it in weights }) { "所有音色都必须有权重" }
...
private fun StyleSelector(
    ...
    Column {
        Text("已选音色:", style = MaterialTheme.typography.labelLarge)
...
private fun WeightSliders(
    ...
    Column {
        Text("音色权重:", style = MaterialTheme.typography.labelLarge)
...
private fun InterpolationModeSelector(
    ...
    Column {
        Text("插值模式:", style = MaterialTheme.typography.labelLarge)
